...
|---|---|---|---|
| [M1](./M1.md) | P0 bugs + low-risk schema cleanup | #1, #2, #9, slice of #10 | this PR |
| [M2](./M2.md) | Claim modeling | #4, #5, additive #6 | deferred |
| [M3](./M3.md) | RP-Initiated Logout (replace iframes) | #3 | deferred |
