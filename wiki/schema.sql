...
CREATE TABLE IF NOT EXISTS "pages" (
  ...
  "created_at"            INTEGER NOT NULL DEFAULT (unixepoch()),
  "updated_at"            INTEGER NOT NULL DEFAULT (unixepoch())
, visibility TEXT NOT NULL DEFAULT 'public', chapter_id TEXT REFERENCES chapters(id) ON DELETE SET NULL);
...
CREATE INDEX "idx_page_access_email"   ON "page_access" ("email");
